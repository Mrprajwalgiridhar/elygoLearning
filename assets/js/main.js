!(function (t) {
      ...
      return this.each(function () {
        ...
        e.find("li").each(function () {
          ...
          e.addClass(a.subMenuClass),
            e.css("display", "none"),
            e.parent().addClass(a.subMenuParent),
            e.prev("a").append(a.appendElement),
            e.next("a").append(a.appendElement);
        });
          ...
          t(this).on("click", function (e) {
            ...
            e.preventDefault(),
              ...
              t(s).next("ul").length > 0
                ? (t(s).parent().toggleClass(a.subMenuParentToggle),
                  t(s).next("ul").slideToggle(a.toggleSpeed),
                  t(s).next("ul").toggleClass(a.subMenuToggleClass))
                : t(s).prev("ul").length > 0 &&
                  (t(s).parent().toggleClass(a.subMenuParentToggle),
                  t(s).prev("ul").slideToggle(a.toggleSpeed),
                  t(s).prev("ul").toggleClass(a.subMenuToggleClass));
          });
        }),
  ...
  t("[data-bg-src]").length > 0 &&
    ...
    t("[data-body-color]").length > 0 &&
      t("[data-body-color]").each(function () {
        ...
        t(this).get(0).style.setProperty("--body-color", e),
          t(this).removeAttr("data-body-color");
      }),
    ...
    t(".th-carousel").on("afterChange", function (e, a, s, i) {
      t(a.$slides).find("[data-ani]").removeClass("th-animated"),
        t(a.$slides[s]).find("[data-ani]").addClass("th-animated");
    });
  var o,
    r,
    c,
    ...
    (t.fn.sectionPosition = function (e, a) {
      t(this).each(function () {
        ...
        (s = Math.floor(c.height() / 2)),
          ...
          "top-half" === i
            ? (t(n).css("padding-bottom", r + s + "px"),
              c.css("margin-top", "-" + s + "px"))
            : "bottom-half" === i &&
              (t(n).css("padding-top", o + s + "px"),
  ...
  t("[data-sec-pos]").length &&
        ...
        if (
          (s.on("click", function (e) {
            ...
            s.addClass("active").siblings().removeClass("active"),
              a.sliderTab
                ? t(n).slick("slickGoTo", s.data("slide-go-to"))
                : r();
          }),
          a.sliderTab)
        ) {
    ...
    t(".testi-card2-tab").length &&
      t(".testi-card2-tab").thTab({ sliderTab: !0, tabButton: ".tab-btn" }),
    t(".service-block-tab").length &&
      t(".service-block-tab").thTab({ sliderTab: !0, tabButton: ".tab-btn" }),
    (t.fn.shapeMockup = function () {
      t(this).each(function () {
        var e = t(this),
          ...
          i = e.data("bottom"),
          n = e.data("left");
        e.css({ top: a, right: s, bottom: i, left: n })
          .removeAttr("data-top")
  ...
  function g() {
    ...
    m[a].then((a) => {
      ...
      e.attr("id") && s.attr("id", e.attr("id")),
        ...
        e.attr("width") &&
          (s.attr("width", e.attr("width")),
          e.attr("height") || s.removeAttr("height")),
        e.attr("height") &&
          (s.attr("height", e.attr("height")),
          e.attr("width") || s.removeAttr("width")),
        s.insertAfter(e),
